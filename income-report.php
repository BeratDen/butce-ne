  ...
  <div class="container-fluid p-0 " id="home">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            ...
            <?php
            $sql = $db->prepare("SELECT income_category, 
            COUNT(*), 
            SUM(income_price) FROM income 
    ...
    <script>
      ...
      const myChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
          labels: [<?php foreach ($income_category as $key => $value) {
                      echo "'" . $key . "',";
                    } ?>],
          datasets: [{
            label: '# of Votes',
            data: [<?php foreach ($income_category as $key => $value) {
                      echo $value . ",";
                    } ?>],
            backgroundColor: [
              <?php foreach ($income_category as $key => $value) {
